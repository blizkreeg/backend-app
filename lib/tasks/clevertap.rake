namespace :clevertap do
  ...
  # To run:
  #   bin/rake clevertap:download_user_profiles_by_event "CT Event Name" YYYYMMDD YYYYMMDD
  #   bin/rake clevertap:download_user_profiles_by_event "App Uninstalled" 20160601 20161231
  task :download_user_profiles_by_event => :environment do
    # http://cobwwweb.com/4-ways-to-pass-arguments-to-a-rake-task
    # writes arguments as empty tasks
