Rails.application.configure do
  ...
  # action mailer smtp_settings at configured in config/initializers/mailer.rb
  config.action_mailer.logger = nil

  config.action_mailer.default_url_options = { host: 'https://brew.ekcoffee.com' }

  routes.default_url_options = { host: 'https://brew.ekcoffee.com' }
