json.cache! profile, expires_in: 24.hours do
  json.(profile, :uuid, :email, :firstname, :lastname, :age, :born_on_year, :born_on_month, :born_on_day, :gender, :intent, :intent_text, :height, :profession, :faith, :highest_degree, :schools_attended, :employer_name, :latitude, :longitude, :location_city, :location_country, :date_preferences, :state, :incomplete, :incomplete_fields, :inactive, :seeking_minimum_age, :seeking_maximum_age, :seeking_minimum_height, :seeking_maximum_height, :seeking_faith, :disable_notifications_setting, :butler_conversation_uuid, :has_new_butler_message)
